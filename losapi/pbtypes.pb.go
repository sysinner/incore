...
func (*ResHostOperate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*ResHost) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*ResHostList) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*ResHostSpec) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*ResPlatform) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (*ResHostResource) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (*ResHostStatus) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (*ResZone) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func (*ResCell) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*ResZoneMasterNode) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
func (*ResZoneMasterList) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }
...
var fileDescriptor0 = []byte{
	...
	,
}
