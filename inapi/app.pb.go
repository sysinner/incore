...
func (*AppSpecDepend) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_f57b71a5f42a2b22, []int{0}
}
...
func (*AppServiceReplica) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_f57b71a5f42a2b22, []int{1}
}
...
func (*AppServicePort) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_f57b71a5f42a2b22, []int{2}
}
...
func (*AppServicePortPodBind) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_f57b71a5f42a2b22, []int{3}
}
...
func (*AppServicePod) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_f57b71a5f42a2b22, []int{4}
}
...
func init() { proto.RegisterFile("inapi/app.proto", fileDescriptor_app_f57b71a5f42a2b22) }

var fileDescriptor_app_f57b71a5f42a2b22 = []byte{
