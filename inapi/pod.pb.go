...
func (PbPodSpecBoxImageDriver) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_pod_d0fe4aca786d0c9b, []int{0}
}
...
func (*PbVolumeMount) Descriptor() ([]byte, []int) {
	return fileDescriptor_pod_d0fe4aca786d0c9b, []int{1}
}
...
func (*PbServicePort) Descriptor() ([]byte, []int) {
	return fileDescriptor_pod_d0fe4aca786d0c9b, []int{2}
}
...
func (*PbPodBoxStatusExecutor) Descriptor() ([]byte, []int) {
	return fileDescriptor_pod_d0fe4aca786d0c9b, []int{3}
}
...
func (*PbPodBoxStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_pod_d0fe4aca786d0c9b, []int{4}
}
...
func init() { proto.RegisterFile("inapi/pod.proto", fileDescriptor_pod_d0fe4aca786d0c9b) }

var fileDescriptor_pod_d0fe4aca786d0c9b = []byte{
