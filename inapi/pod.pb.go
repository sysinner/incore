...
func (PbPodSpecBoxImageDriver) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_pod_38a7876dd3775d7d, []int{0}
}
...
func (*PbVolumeMount) Descriptor() ([]byte, []int) {
	return fileDescriptor_pod_38a7876dd3775d7d, []int{1}
}
...
func (*PbVolumeStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_pod_38a7876dd3775d7d, []int{2}
}
...
func (*PbServicePort) Descriptor() ([]byte, []int) {
	return fileDescriptor_pod_38a7876dd3775d7d, []int{3}
}
...
func (*PbPodBoxStatusExecutor) Descriptor() ([]byte, []int) {
	return fileDescriptor_pod_38a7876dd3775d7d, []int{4}
}
...
func (*PbPodBoxStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_pod_38a7876dd3775d7d, []int{5}
}
...
func init() { proto.RegisterFile("inapi/pod.proto", fileDescriptor_pod_38a7876dd3775d7d) }

var fileDescriptor_pod_38a7876dd3775d7d = []byte{
	// 725 bytes of a gzipped FileDescriptorProto
	,
}
